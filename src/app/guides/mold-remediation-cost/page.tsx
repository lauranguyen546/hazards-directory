...
const FAQS = [
  {
    ...
    answer: 'Average mold remediation costs range from $500 to $6,000 depending on the affected area size and mold type. Small jobs (one room) typically cost $500–$1,500. Whole-home or HVAC remediation can reach $10,000+.',
  },
  {
    question: 'Does homeowners insurance cover mold removal?',
    answer: 'It depends on the cause. Insurance typically covers mold from a sudden covered peril (burst pipe, storm). It usually does not cover mold from neglect, gradual leaks, or flooding (which requires separate flood insurance).',
  },
  {
    question: 'How long does mold remediation take?',
    answer: 'Small jobs take 1–3 days. Medium-sized projects (multiple rooms) take 3–7 days. Large-scale remediation including drywall replacement can take 1–2 weeks.',
  },
]
...
export default function MoldRemediationCostPage() {
  ...
  const breadcrumb = generateBreadcrumbSchema([
    ...
    { name: 'Mold Removal Cost' },
  ])
  const faqSchema = generateFAQSchema(FAQS)
  const articleSchema = generateArticleSchema({
    title: 'Mold Removal Cost Guide 2026',
    description: 'Average cost of mold remediation by type, room, and severity.',
        ...
        <div className="max-w-4xl mx-auto px-4 py-10">
          <div className="lg:grid lg:grid-cols-3 lg:gap-10">
            <article className="lg:col-span-2">
              ...
              <h1 className="text-3xl font-bold text-gray-900 mt-2 mb-4">Mold Removal Cost Guide 2026</h1>
              ...
              <ul className="space-y-2 text-gray-700 mb-6 list-disc pl-5">
                <li><strong>Square footage affected</strong> — Most pros charge $10–$25 per sq ft</li>
                <li><strong>Mold type</strong> — Black mold requires more extensive containment</li>
                <li><strong>Accessibility</strong> — Inside walls, crawl spaces, or attics cost more</li>
                <li><strong>Structural damage</strong> — Replacing drywall or insulation adds $1,000–$5,000</li>
                <li><strong>Post-remediation testing</strong> — Add $200–$500 for air quality verification</li>
              </ul>

              <div className="my-8">
                <p className="text-sm text-gray-600 mb-3">
                  <strong>Before calling a pro:</strong> Get a rough sense of severity with a DIY test kit to compare quotes more accurately.
                </p>
                <AffiliateProductCard program="amazon_mold_kit" sourcePage="/guides/mold-remediation-cost" sourceCategory="Mold" />
              </div>

              <h2 className="text-xl font-bold text-gray-900 mb-3">Does Insurance Cover It?</h2>
              <p className="text-gray-700 mb-3">Coverage depends entirely on the <em>cause</em> of the mold:</p>
              <ul className="space-y-2 text-gray-700 mb-6 list-disc pl-5">
                <li><strong>Usually covered:</strong> Mold from a burst pipe, appliance leak, or roof damage from a storm</li>
                <li><strong>Usually not covered:</strong> Mold from long-term neglect, humidity, or flooding</li>
              </ul>

              <div className="my-6">
                <AffiliateProductCard program="policygenius_insurance" sourcePage="/guides/mold-remediation-cost" sourceCategory="Mold" />
              </div>
              ...
              <div className="bg-blue-50 rounded-xl p-5">
                ...
                <ul className="space-y-2 text-sm">
                  ...
                  <li><Link href="/guides/how-to-choose-mold-remediation-company" className="text-primary-600 hover:underline">How to Choose a Mold Remediation Company →</Link></li>
            ...
            <aside className="mt-10 lg:mt-0 space-y-6">
              <LeadCaptureForm prefilledCategory="Mold" sourcePage="/guides/mold-remediation-cost" compact />
